...
/// 不 clone 整个仓库。目标文件 = <nodelistDirectory>/nodelist/custom-node-list.json
/// </summary>
public sealed class NodelistDownloader
{
    ...
    /// {nodelistDirectory}/nodelist/custom-node-list.json
    /// </summary>
        ...
        CancellationToken ct = default)
    {
        ...
        var destDir = Path.Combine(nodelistDirectory, "nodelist");
